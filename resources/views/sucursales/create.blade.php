            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        Usted se encuentra en el modulo de Administracion de Sucursal Creacion.
                    </p>
                    <hr>
                    @include('flash::message')
                    <form action="{{Route('sucursal.store')}}" method="post" id="form">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group row col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control input-mask" type="text"  id="telefono" name="telefono" data-inputmask="'mask': '9999-9999'" im-insert="true" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group row col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <textarea class="form-control" cols="30" rows="3" id="dirreccion" name="dirreccion" required></textarea>
                                        </div>
                                    </div>
