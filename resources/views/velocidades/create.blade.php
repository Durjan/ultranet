            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">
                        Usted se encuentra en el modulo de Administracion de velocidadades de internet Creacion.
                    </p>
                    <hr>
                    @include('flash::message')
                    <form action="{{Route('velocidades.store')}}" method="post" id="form">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="form-group row col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control" type="text"  id="detalle" name="detalle" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group row col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control" type="number"  id="bajada" name="bajada" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group row col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input class="form-control " type="number"  id="subida" name="subida"  >
                                        </div>
                                    </div>
